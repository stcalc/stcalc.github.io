function calcu() {
  ...
  var ch1tt = document.getElementById('ch1tt').value = Number((ch1ntd)*0.2+(ch1ctrl*0.6)+(ch1ntp*0.2));
    ...
    var ana3tt = document.getElementById('ana3tt').value = Number((((ana3ntd)*4)+(ana3ctrl*6))/10);
      ...
      var eng3tt = Number(document.getElementById('eng3tt').value);




      document.getElementById("tt").innerHTML = ((3*ph1tt)+(3*ch1tt)+(2*ana1tt)+(2*ana2tt)+(2*ana3tt)+(2*algg1tt)+(2*alg1tt)+eng1tt+eng2tt+eng3tt)/19;
